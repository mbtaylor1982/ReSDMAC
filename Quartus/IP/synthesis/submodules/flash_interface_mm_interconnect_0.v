// flash_interface_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module flash_interface_mm_interconnect_0 (
	...
	flash_interface_mm_interconnect_0_router router (
	...
	flash_interface_mm_interconnect_0_router_001 router_001 (
	...
	flash_interface_mm_interconnect_0_router_001 router_002 (
	...
	flash_interface_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_source_clk_clk),                              //       clk.clk
		.reset              (avalon_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	flash_interface_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_source_clk_clk),                              //       clk.clk
		.reset               (avalon_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	flash_interface_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_source_clk_clk),                              //       clk.clk
		.reset               (avalon_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	flash_interface_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_source_clk_clk),                              //       clk.clk
		.reset              (avalon_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	flash_interface_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_source_clk_clk),                              //       clk.clk
		.reset              (avalon_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	flash_interface_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_source_clk_clk),                              //       clk.clk
		.reset               (avalon_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	flash_interface_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
