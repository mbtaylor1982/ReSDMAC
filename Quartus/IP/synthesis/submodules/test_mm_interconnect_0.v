...
module test_mm_interconnect_0 (
		...
		input  wire [23:0] bridge_0_avalon_master_address,             //               bridge_0_avalon_master.address
	...
	wire  [23:0] bridge_0_avalon_master_translator_avalon_universal_master_0_address;       // bridge_0_avalon_master_translator:uav_address -> bridge_0_avalon_master_agent:av_address
	...
	wire  [96:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> bridge_0_avalon_master_agent:rp_data
	...
	wire  [23:0] onchip_flash_0_csr_agent_m0_address;                                       // onchip_flash_0_csr_agent:m0_address -> onchip_flash_0_csr_translator:uav_address
	...
	wire  [97:0] onchip_flash_0_csr_agent_rf_source_data;                                   // onchip_flash_0_csr_agent:rf_source_data -> onchip_flash_0_csr_agent_rsp_fifo:in_data
	...
	wire  [97:0] onchip_flash_0_csr_agent_rsp_fifo_out_data;                                // onchip_flash_0_csr_agent_rsp_fifo:out_data -> onchip_flash_0_csr_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> onchip_flash_0_csr_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // onchip_flash_0_csr_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> onchip_flash_0_csr_agent:cp_channel
	...
	wire  [23:0] onchip_flash_0_data_agent_m0_address;                                      // onchip_flash_0_data_agent:m0_address -> onchip_flash_0_data_translator:uav_address
	...
	wire  [97:0] onchip_flash_0_data_agent_rf_source_data;                                  // onchip_flash_0_data_agent:rf_source_data -> onchip_flash_0_data_agent_rsp_fifo:in_data
	...
	wire  [97:0] onchip_flash_0_data_agent_rsp_fifo_out_data;                               // onchip_flash_0_data_agent_rsp_fifo:out_data -> onchip_flash_0_data_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> onchip_flash_0_data_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // onchip_flash_0_data_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> onchip_flash_0_data_agent:cp_channel
	...
	wire  [96:0] bridge_0_avalon_master_agent_cp_data;                                      // bridge_0_avalon_master_agent:cp_data -> router:sink_data
	...
	wire         onchip_flash_0_csr_agent_rp_valid;                                         // onchip_flash_0_csr_agent:rp_valid -> router_001:sink_valid
	wire  [96:0] onchip_flash_0_csr_agent_rp_data;                                          // onchip_flash_0_csr_agent:rp_data -> router_001:sink_data
	wire         onchip_flash_0_csr_agent_rp_ready;                                         // router_001:sink_ready -> onchip_flash_0_csr_agent:rp_ready
	wire         onchip_flash_0_csr_agent_rp_startofpacket;                                 // onchip_flash_0_csr_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         onchip_flash_0_csr_agent_rp_endofpacket;                                   // onchip_flash_0_csr_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire         onchip_flash_0_data_agent_rp_valid;                                        // onchip_flash_0_data_agent:rp_valid -> router_002:sink_valid
	wire  [96:0] onchip_flash_0_data_agent_rp_data;                                         // onchip_flash_0_data_agent:rp_data -> router_002:sink_data
	wire         onchip_flash_0_data_agent_rp_ready;                                        // router_002:sink_ready -> onchip_flash_0_data_agent:rp_ready
	wire         onchip_flash_0_data_agent_rp_startofpacket;                                // onchip_flash_0_data_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         onchip_flash_0_data_agent_rp_endofpacket;                                  // onchip_flash_0_data_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	test_mm_interconnect_0_router_001 router_002 (
